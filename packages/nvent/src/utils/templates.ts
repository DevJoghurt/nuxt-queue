...
/**
 * Generate the function registry template content
 */
...
export function generateHandlersTemplate(registry: any): string {
  ...
  regWorkers
    ...
    .forEach((w: any, i: number) => {
      ...
      // Include both handler and module in the entry
