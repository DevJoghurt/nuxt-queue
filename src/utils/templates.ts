...
export function generateAnalyzedFlowsTemplate(registry: any): string {
  ...
  return `// auto-generated by nuxt-queue
export const analyzedFlows = ${JSON.stringify(analyzedFlows, null, 2)} as const;

export type AnalyzedFlows = typeof analyzedFlows;

export const useAnalyzedFlows = (): AnalyzedFlows => analyzedFlows;
